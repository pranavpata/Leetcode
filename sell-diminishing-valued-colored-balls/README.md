<h2>1648. Sell Diminishing-Valued Colored Balls</h2><h3>Medium</h3><hr><div><p>You have an <code>inventory</code> of different colored balls, and there is a customer that wants <code>orders</code> balls of <strong>any</strong> color.</p>
